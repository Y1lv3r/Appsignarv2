...
<?php include ("modulos/estados.php") ?>
<?php include("./cabeceras/cabecera_Estados.php") ?>
    ...
    <br>
        <div  class="card shadow mb-2">
                <div class="card-header py-3"> 
                    <h4 class="m-0 font-weight-bold text-primary" class="label" align="center">Estado</h4>
                </div>
    <div class="row">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input name="ID" id="ID" value="<?php echo $ID; ?>" class="form-control" type="hidden" REQUIRED placeholder="Enter your last name" />
                            ...
                            <div class="form-group col-md-7">
                                ...
                                <button value="btnEliminar" onclick=" return Confirmar('¿Desea eliminar este estado?');" <?php echo $accionEliminar; ?> class="btn btn-danger" type="submit" name="accion">Eliminar</Button>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary" class="label" align="center">Tabla Estados</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table display nowrap" id="example" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Acciones</th>
                            <th>Nombre del estado<span></span></th>
                        ...
                        <?php foreach ($listaEmpleados as $empleado) { ?>
                            ...
                            <td>
                                    <form action="" method="post">
                                        ...
                                        <button value="btnEliminar" onclick=" return Confirmar('¿Desea eliminar este estado?');" type="submit" class="btn btn-danger" name="accion">Eliminar</Button>
                                    </form>
                                </td>
