...
<?php
  ...
  $sqlEmple = "SELECT * FROM empleados WHERE Nombre != 'Administrador' AND Nombre != 'Administrador2' AND Nombre != 'Administrador3'";
        ...
        <div class="col-xl-12 col-lg-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary" class="label" align="center">Estado de asignación por área - <?php echo date('Y'); ?></h5>
                </div>
