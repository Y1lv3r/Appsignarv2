    ...
    <div class="row">
        <div class="col-xl-12 col-lg-7">
            <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title m-0 font-weight-bold text-primary" id="exampleModalLabel">EMPLEADO</h5>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php if ($txtFoto != "") { ?>
                                            ...
                                            <img class="img-thumbnail rounded mx-auto d-block" width="100px" src="../appsignar_limpio/imagenes/perfil/<?php echo $txtFoto; ?>" />
                                            </br>
                                        <?php } ?>
                ...
                <br><br>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">AGREGAR EMPLEADO</button>
                <br><br>
            </form>
        </div>
    </div>
                    ...
                    <tbody>
                        <?php foreach ($listaEmpleados as $empleado) { ?>
                            <tr>
                                ...
                                <td><img class="img-thumbnail" width="100px" src="../appsignar_limpio/imagenes/perfil/<?php echo $empleado['Foto']; ?>" /></td>
