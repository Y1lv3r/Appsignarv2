...
<?php include ("modulos/Divisones.php") ?>
<?php include("./cabeceras/cabecera_Divisiones.php") ?>
    ...
    <br>
        <div  class="card shadow mb-2">
                <div class="card-header py-3"> 
                    <h4 class="m-0 font-weight-bold text-primary" class="label" align="center">Division</h4>
                </div>
            <div class="row">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input name="ID" id="ID" value="<?php echo $ID; ?>" class="form-control" type="hidden" REQUIRED placeholder="Enter your last name" />
                                    ...
                                    <div class="modal-body">
                                        <div class="form-row">
                                            <div class="form-group col-md-12" align="left">
                                                ...
                                                <input type="text" class="form-control <?php echo (isset($error['Nombres'])) ? "is-invalid" : ""; ?>" REQUIRED name="txtNombres" value="<?php echo $txtNombres; ?>" placeholder="" id="txtNombres" require="">
                                    ...
                                    <div class="form-group col-md-7">
                                        ...
                                        <button value="btnEliminar" onclick=" return Confirmar('¿Desea eliminar esta división?');" <?php echo $accionEliminar; ?> class="btn btn-danger" type="submit" name="accion">Eliminar</Button>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary" class="label" align="center">Tabla Divisiones</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table display nowrap" id="example" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Acciones</th>
                            <th>Nombre de la división<span></span></th>
                        ...
                        <?php foreach ($listaEmpleados as $empleado) { ?>
                            ...
                            <td>
                                    <form action="" method="post">
                                        ...
                                        <button value="btnEliminar" onclick=" return Confirmar('¿Desea eliminar esta división?');" type="submit" class="btn btn-danger" name="accion">Eliminar</Button>
                                    </form>
                                </td>
