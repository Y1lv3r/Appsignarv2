...
<?php include("./cabeceras/cabecera_Proyectos.php") ?>
...
<div class="container-fluid"  align="center">
 <div class="col-xl-10 col-lg-7" align="left">
    <br>
    <br>
    <div class="card shadow mb-4">
        <div class="card-header py-3"> 
            <h4 class="m-0 font-weight-bold text-primary" class="label" align="center">Proyecto</h4>
        </div>
        <div class="row">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <input name="txt" id="txt" value="<?php echo $txt; ?>" class="form-control" type="hidden" REQUIRED placeholder="Enter your last name" />
                   
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label class="m-0 font-weight-bold text-primary">Nombre del proyecto:</label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="m-0 font-weight-bold text-primary">PEP Consultoría:</label>
                                            <input type="text" class="form-control <?php echo (isset($error['Nombre'])) ? "is-invalid" : ""; ?>" name="txtPepConsultor" value="<?php echo $txtPepConsultor; ?>" placeholder="" id="txtPepConsultor" require="">
                                            <div class="invalid-feedback">
                                                <?php echo (isset($error['Nombre'])) ? $error['Nombre'] : ""; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="m-0 font-weight-bold text-primary">PEP Técnico:</label>
                                            <input type="text" class="form-control <?php echo (isset($error['Nombre'])) ? "is-invalid" : ""; ?>" name="txtPepTecnico" value="<?php echo $txtPepTecnico; ?>" placeholder="" id="txtPepTecnico" require="">
                                            <div class="invalid-feedback">
                                                <?php echo (isset($error['Nombre'])) ? $error['Nombre'] : ""; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="m-0 font-weight-bold text-primary">Responsable:</label>
                                            <select class="form-control mb-2 mr-sm-2" name="txtresponsable" id="txtresponsable">
                                                <option><?php echo  $txtMresponsable ?></option>
                                                <?php foreach ($listaResponsable as $opcionesR) : ?>
                                                    <option value="<?php echo $opcionesR['Nombre'] ?>"><?php echo $opcionesR['Nombre']; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label class="m-0 font-weight-bold text-primary">Responsable Backup:</label>
                                            <select class="form-control mb-2 mr-sm-2" name="txtresponsablebackup" id="txtresponsablebackup">
                                                <option><?php echo  $txtMresponsablebackup ?></option>
                                                <?php foreach ($listaResponsable as $opcionesR) : ?>
                                                    <option value="<?php echo $opcionesR['Nombre'] ?>"><?php echo $opcionesR['Nombre']; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label class="m-0 font-weight-bold text-primary">Descripción:</label>
                                            <input type="text" class="form-control <?php echo (isset($error['Nombre'])) ? "is-invalid" : ""; ?>" name="txtDescripcion" value="<?php echo $txtDescripcion; ?>" placeholder="" id="txtDescripcion" require="">
                                            <div class="invalid-feedback">
                                                <?php echo (isset($error['Nombre'])) ? $error['Nombre'] : ""; ?>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <button value="btnEliminar" onclick=" return Confirmar('¿Desea eliminar este proyecto?');" <?php echo $accionEliminar; ?> class="btn btn-danger" type="submit" name="accion">Eliminar</Button>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-primary" class="label" align="center">Tabla Proyectos</h4>
            <?php if ($rol['Rol'] == $rol1) { ?>
                <a href="./modulos/exportar_excel_proy.php"> <button style="position: absolute;top: 0.3cm;left: 88%; z-index: 2;" class="btn btn-primary">EXCEL&nbsp;&nbsp;&nbsp;<i class="fa fa-download" aria-hidden="true"></i></button></a>
            <?php } ?>
        </div>
        <div class="card-body">
                ...
                <table class="table display nowrap" id="example" class="display" cellspacing="0" width="100%">
                    <thead>
                        <tr> <th>
                            ...
                            <th>Nombre<br>del proyecto <span></span></th>
                            <th>PEP<br>Consultoría<span></span></th>
                            <th>PEP<br>Técnico<span></span></th>
                            <th>Descripción<span></span></th>
                            <th>Responsable<span></span></th>
                            <th>Responsable<br>Backup<span></span></th>
                            <th>Fecha<br>de registro<span></span></th>
                           
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($listaEmpleados as $proyecto) { ?>
                            <tr>
                            <td>
                                    <?php if ($rol['Rol'] == $rol1) { ?>
                                ...
                                <td><?php echo $proyecto['PepConsultor'] ?></td>
                                <td><?php echo $proyecto['PepTecnico'] ?></td>
                                <td><?php echo $proyecto['Descripcion'] ?></td>
                                <td><?php echo $proyecto['Responsable'] ?></td>
                                <td><?php echo $proyecto['ResponsableBackup'] ?></td>
